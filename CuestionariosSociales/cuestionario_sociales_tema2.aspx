<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cuestionario_sociales_tema2.aspx.cs" Inherits="SOFTCOLJAGA.CuestionariosNaturales.cuestionario_naturales_tema1" %>
            ...
            <div class="templatemo_content">
                ...
                <div id="templatemo_content_white_middle">
                	<div class="templatemo_post_area">
                    	...
                    	<h1>Cuestionario Sociales Tema 2</h1>
    <form runat ='server'>             
                ...
                <div id="templatemo_content_two_col_middle">
                	<div class="templatemo_post_area_left">
                    	<h1>Contenido Sociales</h1>
                         <ul>
							<li><a href="../Sociales_/sociales_tema1.aspx">Tema 1 - El Clima Y La Vegetacion</a></li>
							<li><a href="../Sociales_/sociales_tema2.aspx">Tema 2 - Temperatura</a></li>
                            <li><a href="../Sociales_/sociales_tema3.aspx">Tema 3 - Regimen De Lluvias</a></li>
                            <li><a href="../Sociales_/sociales_tema4.aspx">Tema 4 - Vientos Y Brisas Del Mar</a></li>
                            <li><a href="../Sociales_/sociales_tema5.aspx">Tema 5 - Fenomeno Del Niño</a></li>
                            <li><a href="../Sociales_/sociales_tema6.aspx">Tema 6 - Fenomeno De La Niña</a></li>
                        </ul>
                    ...
                    <div class="templatemo_post_area_right">
                        ...
                        <ul>
							<li><a href="cuestionario_sociales_tema1.aspx">Cuestionario Tema 1</a></li>
							<li><a href="cuestionario_sociales_tema2.aspx">Cuestionario Tema 2</a></li>
                            <li><a href="cuestionario_sociales_tema3.aspx">Cuestionario Tema 3</a></li>
                            <li><a href="cuestionario_sociales_tema4.aspx">Cuestionario Tema 4</a></li>
                            <li><a href="cuestionario_sociales_tema5.aspx">Cuestionario Tema 5</a></li>
                            <li><a href="cuestionario_sociales_tema6.aspx">Cuestionario Tema 6</a></li>
                        </ul>
