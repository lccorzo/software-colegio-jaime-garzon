<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CrearPreguntas.aspx.cs" Inherits="SOFTCOLJAGA.CrearPreguntas" %>
...
<!--  Free CSS Templates from www.templatemo.com -->
    ...
    <form id="Form1" runat ='server' method ="post"  >             
                           <asp:Label ID='Label2' runat = 'server' >Materia</asp:Label>     
   ...
   <LayoutTemplate>
     ...
     <ItemTemplate>
						    ...
						    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:DropDownList ID="DropDownList1" runat="server">
                               ...
                               <asp:ListItem>EduFisica</asp:ListItem>
                           </asp:DropDownList>
                           <br />
                           <br />
                           <asp:Label ID="Label10" runat="server" Text="Tema"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                           <asp:TextBox ID="TextBox6" runat="server"></asp:TextBox>
                           <br />
                           <br />
                           <asp:Label ID='Label4' runat = 'server' >Pregunta :</asp:Label>     
                                        
                                        
                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     
                                        
                                        
                           <asp:TextBox ID="TextBox2" runat="server" Height="37px" Width="661px"></asp:TextBox>
                           <br />
                           <br />
                           <asp:Label ID="Label6" runat="server" Text="Respuesta Correcta"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                           ...
                           <br />
                           <br />
                           <asp:Label ID="Label7" runat="server" Text="Respuesta Mal 1"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                           <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
                           <br />
                           <br />
                           <asp:Label ID="Label8" runat="server" Text="Respuesta Mal 2"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                           <asp:TextBox ID="TextBox4" runat="server"></asp:TextBox>
                           <br />
                           <br />
                           <asp:Label ID="Label9" runat="server" Text="Respuesta Mal 3"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
