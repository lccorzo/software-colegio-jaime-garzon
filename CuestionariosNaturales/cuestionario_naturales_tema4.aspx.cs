...
{
    public partial class cuestionario_naturales_tema4 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                tabla1 = SOFTCOLJAGA.Seleccionar.Seleccionar.Obtener("Select cod_pregunta,pregunta,respuesta_correcta,respuesta_mal1,respuesta_mal2,respuesta_mal3 from pregunta where materia='naturales' and tema='4'");
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SOFTCOLJAGA.Seleccionar.Seleccionar.ObtenerSinReturn("insert into cuestionario (cod_cuestionario, calificacion, materia, tema, usuario) values (" + cuest + "," + calificacion + ",'matematicas','4',"+Session["Entrada"].ToString()+")");
