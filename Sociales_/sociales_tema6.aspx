<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sociales_tema6.aspx.cs" Inherits="SOFTCOLJAGA.Sociales_.sociales_tema6" %>
            ...
            <div class="templatemo_content">
                ...
                <div id="templatemo_content_white_middle">
                	<div class="templatemo_post_area">
                    	...
                    	<h1>Fenomeno De La Niña</h1>
                      <p><img alt="Design Gallery" src="../images/sociales/imagen13.jpg" />Tanto el NIÑO 
                          como LA NIÑA, son los ejemplos más evidentes de las oscilaciones climáticas 
                          globales, siendo parte fundamental de un vasto y complejo sistema de 
                          flictuaciones climáticas. La niña ese caracteriza por temperaturas frías y 
                          perdurables, se le compara con el NIÑO ya que éste se caracteriza por 
                          temperaturas oceánicas inusualmente calientes sobre el Océano Pacífico 
                          Ecuatorial.</p>
        	...
        	<div class="templatemo_content">
                ...
                <div id="templatemo_content_blue_middle">
                	<div class="templatemo_post_area">
                    	<h1>...</h1>
                        <h3>
                            <asp:ImageMap ID="ImageMap1" runat="server" Height="183px" 
                                ImageUrl="~/images/sociales/imagen12.jpg" Width="276px" 
                                onclick="ImageMap1_Click">
                            </asp:ImageMap>
                            ...</h3>
                            <p>Los episodios de la NIÑA  también producen cambios a gran escala en los vientos atmosféricos sobre el Océano Pacífico Tropical, incluyendo un incremento en la intensidad de los vientos  Alisios de Este (Este-Oeste) en la atmósfera baja sobre el océano Pacifico Oriental y de los del oeste en la atmósfera superior. Estas condiciones reflejan cambios significativos en la circulación ecuatorial de Walker.</p>
                        <p>&nbsp;</p>
                        <p><a href="sociales_tema5.aspx">Atras Tema 5</a></p>
                      <div class="cleaner_with_height"></div>
                    </div>
                </div><!-- End Of Content Middle -->
